...
from hs_fetch.fast_fetch.fast_fetch_interactive_input import get_interactive_input_from_put_request, \
    FetchInteractiveInputParameters, FetchInteractiveParameterFields
...
from hs_fetch.fast_fetch.fast_fetch_filtering_query_builder import SpecificTalentIdsQueryFilter, \
    ...
    get_talent_fast_fetch_query_builder
...
filters_to_use = [TitlesSimilarityFeaturesFilter(filter_only_if_resume_data_exist=True,
                                                 only_if_enough_coverage=True), SpecificTalentIdsQueryFilter()]
...
kwargs = {
    ...
    # 'max_apply_since_days': {'value': 730},
    ...
    # 'min_years_of_relevant_experience': {'value': 5.0},
...
result = fetch_api.do_fast_fetch_group_by_counts(interactive_input)
print()
print((datetime.datetime.now() - now).total_seconds(), 'seconds')
